  ...
  <script>
    $(document).ready(function(){
      ...
      $('#summernote-editor').summernote({
        ...
        'fontNames': ['Courier', 'Franklin Gothic', 'Fran', 'Georgia', 'Jost', 'Helvetica', 'Impact', 'Merriweather', 'Tahoma', 'Times', 'Verdana', 'Poppins'],
'fontNamesIgnoreCheck': ['Courier', 'Franklin Gothic', 'Fran', 'Georgia', 'Jost', 'Helvetica', 'Impact', 'Merriweather', 'Tahoma', 'Times', 'Verdana', 'Poppins'],
      })
    });
  </script>
</body>
