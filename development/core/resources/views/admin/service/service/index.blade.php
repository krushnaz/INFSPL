...
<style>
    ...
    form:not(.modal-form) .note-editor.note-frame .note-editing-area .note-editable {
     ...
     .note-dropdown-menu .note-fontname {
        ...
        <div class="modal-content">
            ...
            <form id="ajaxForm" class="modal-form" action="{{route('admin.service.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="service_fees" value="" placeholder="Enter Service Fees (e.g., 100 USD, Free, Contact for pricing)" pattern=".*" inputmode="text">
